...
customerId:any;
  ...
  callAcccountDetails(accountType:any){
    // this.typeOfAccount.getAccountDetails(this.customerId,accountType)
    // .subscribe((account_details:any)=>{
  ...
  getTypeOfAccounts(){
    ...
    .subscribe((accountType:any)=>{
      ...
      this.listOfAccountTypes=accountType.response.accountType//last accountType is the field name passed in array of object
